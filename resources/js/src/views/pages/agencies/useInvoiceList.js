...
export default function useInvoicesList() {
  ...
  const tableColumns = [
    ...
    {label: i18n.t('name') ,key: 'name', sortable: true },
    { label: i18n.t('Address'),key: 'address.district', sortable: true },
    { label: i18n.t('Stock'),key: 'main_stock.name', sortable: true },
    { label: i18n.t('Director') ,key: 'director', sortable: true },
