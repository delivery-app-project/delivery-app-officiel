<template>
  <b-card-code :title="$t('Add Agency')">
    ...
    validationForm() {
      this.$refs.simpleRules.validate().then((success) => {
        if (success) {
          ...
          const data = {
            stock_id: this.stock ? this.stock.id : null,
            name: this.name,
          ...
          store.dispatch("app-agency/storeAgency", data).then((response) => {
